...
class QuizManagementSystem {
    private String[] questions = {"What is the capital of France?","Who wrote 'Romeo and Juliet'?","What is the largest ocean on Earth?","What is the result of 7 * 6?","What year did World War II end?"};
    private String[] answers = {"Paris","William Shakespeare","Pacific","42","1945"};
